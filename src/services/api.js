...
export const seancesAPI = {
  ...
  getDisponibilites: (tuteurId) => api.get('/seances/disponibilites', { params: { tuteurId } }),
...
export const adminAPI = {
  ...
  bloquer: (id, bloquer) => api.put(`/admin/utilisateurs/${id}/bloquer`, { bloquer }),
  supprimer: (id) => api.delete(`/admin/utilisateurs/${id}`),
  getTuteursPending: () => api.get('/admin/tuteurs/pending'),
  validerTuteur: (id, accepte) => api.put(`/admin/tuteurs/${id}/valider`, { accepte }),
